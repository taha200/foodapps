        ...
        >
          ...
          >
            ...
            >
              ...
              <Text
              style={{ color: "black", fontSize: 16,marginTop:10, fontWeight:"bold" }}
              
            >
              Don't have an account?
            </Text>
            <Text
              style={{ color: "#D25400", fontSize: 16,marginTop:10, fontWeight:"bold" }}
...
export async function requestLocationPermission() {
  try {
    const granted = await PermissionsAndroid.request(
      ...
      {
        title: "La Foodies",
        message: "La Foodies App access to your location "
      }
    );
